exports.run = (client, message) => {
  ...
  if ((message.content.startsWith(settings.prefix + "live-twitch") && message.author.id == "278697796398481408") || //if the bot sends the message
    (message.content.startsWith(settings.prefix + "live-twitch") && message.author.id == "145367010489008128" && message.channel.id == "278697660133801984")) { //if comixs sends the message (and in certian chat)
