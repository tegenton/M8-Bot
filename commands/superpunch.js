exports.run = async (client, message, args, level) => { // eslint-disable-line no-unused-vars
  ...
  if (message.mentions.members.size == 1) {
    ...
    return message.reply("you must mention someone to punch.")
  }
  ...
  await message.channel.send(new Attachment(
    await client.idiotAPI.superPunch(message.author.displayAvatarURL, target.displayAvatarURL),
    "superpunch.png"));
