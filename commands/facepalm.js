exports.run = async (client, message, args, level) => { // eslint-disable-line no-unused-vars
  ...
  let msg
  msg = await message.channel.send(`<a:loading:417323455147540490> ${target.username} is doing something stupid...`);

  await message.channel.send(new Attachment(
    await client.idiotAPI.facepalm(target.displayAvatarURL),
    "facepalm.png"));
