exports.run = async (client, message, args, level) => { // eslint-disable-line no-unused-vars
  ...
  let msg
  msg = await message.channel.send(`<a:loading:417323455147540490> ${target.username} is capturing Zero Two's heart...`);

  await message.channel.send(new Attachment(
    await client.idiotAPI.zerotwo(target.displayAvatarURL),
    "02picture.png"));
