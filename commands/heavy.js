exports.run = async (client, message, args, level) => { // eslint-disable-line no-unused-vars
  ...
  let msg
  msg = await message.channel.send(`<a:loading:417323455147540490> ${target.username} is dancing in Pyro Land...`);

  await message.channel.send(new Attachment(
    await client.idiotAPI.heavyFear(target.displayAvatarURL),
    "heavyfear.png"));
...
exports.help = {
  name: "heavy",
  category: "Memes",
  description: "Get a heavy fear image.",
  usage: "heavy @Person"
};