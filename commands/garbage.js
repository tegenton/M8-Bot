exports.run = async (client, message, args, level) => { // eslint-disable-line no-unused-vars
  ...
  let msg
  msg = await message.channel.send(`<a:loading:417323455147540490> ${target.username} is being forced into hiding...`);

  await message.channel.send(new Attachment(
    await client.idiotAPI.garbage(target.displayAvatarURL),
    "garbage.png"));
...
exports.help = {
  name: "garbage",
  category: "Memes",
  description: "Get a garbage image.",
  usage: "garbage @Person"
};